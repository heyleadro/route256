...
// Validate checks the field values on UserItems with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *UserItems) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UserItems with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UserItemsMultiError, or nil
// if none found.
func (m *UserItems) ValidateAll() error {
	return m.validate(true)
}

func (m *UserItems) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UserItemsMultiError(errors)
	}

	return nil
}

// UserItemsMultiError is an error wrapping multiple validation errors returned
// by UserItems.ValidateAll() if the designated constraints aren't met.
type UserItemsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UserItemsMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UserItemsMultiError) AllErrors() []error { return m }

// UserItemsValidationError is the validation error returned by
// UserItems.Validate if the designated constraints aren't met.
type UserItemsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserItemsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserItemsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserItemsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserItemsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserItemsValidationError) ErrorName() string { return "UserItemsValidationError" }

// Error satisfies the builtin error interface
func (e UserItemsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = UserItemsValidationError{}
...
func (m *ListOrderResponse) validate(all bool) error {
	...
	if _, ok := _ListOrderResponse_Status_InLookup[m.GetStatus()]; !ok {
...
var _ListOrderResponse_Status_InLookup = map[string]struct{}{
	"new":              {},
	"awaiting payment": {},
	"failed":           {},
	"payed":            {},
